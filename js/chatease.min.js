chatease=function(){if(chatease.api)return chatease.api.getInstance.apply(this,arguments)};chatease.version="1.2.00";
...
{display:"none"});b("."+a+" .cha-render .cha-dialog textarea",{padding:"6px 10px",width:l.config.width-90+"px",height:"48px",resize:"none",border:"0 none","background-color":"#E6E6E6"});b("."+a+" .cha-render .cha-dialog .send",{width:"50px",height:"100%",top:"0",right:"0",position:"absolute"})}})(chatease);
