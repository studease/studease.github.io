chatease=function(){if(chatease.api)return chatease.api.getInstance.apply(this,arguments)};chatease.version="1.1.06";
...
(function(d){var f=d.utils;d=f.crypt={};d.stringToByteArray=function(e){for(var f=[],c=0,b=0;b<e.length;b++){for(var a=e.charCodeAt(b);255<a;)f[c++]=a&255,a>>=8;f[c++]=a}return f};d.byteArrayToString=function(e){if(8192>=e.length)return String.fromCharCode.apply(null,e);for(var f="",c=0;c<e.length;c+=8192){var b=Array.slice(e,c,c+8192);f+=String.fromCharCode.apply(null,b)}return f};d.byteArrayToHex=function(e){return Array.map(e,function(e){e=e.toString(16);return 1<e.length?e:"0"+e}).join("")};d.hexToByteArray=
function(e){if(0!==e.length%2)return f.log("Key string length must be multiple of 2."),null;for(var d=[],c=0;c<e.length;c+=2)d.push(parseInt(e.substring(c,c+2),16));return d};d.stringToUTF8ByteArray=function(e){for(var f=[],c=0,b=0;b<e.length;b++){var a=e.charCodeAt(b);128>a?f[c++]=a:(2048>a?f[c++]=a>>6|192:(55296==(a&64512)&&b+1<e.length&&56320==(e.charCodeAt(b+1)&64512)?(a=65536+((a&1023)<<10)+(e.charCodeAt(++b)&1023),f[c++]=a>>18|240,f[c++]=a>>12&63|128):f[c++]=a>>12|224,f[c++]=a>>6&63|128),f[c++]=
a&63|128)}return f};d.UTF8ByteArrayToString=function(e){for(var f=[],c=0,b=0;c<e.length;){var a=e[c++];if(128>a)f[b++]=String.fromCharCode(a);else if(191<a&&224>a){var h=e[c++];f[b++]=String.fromCharCode((a&31)<<6|h&63)}else if(239<a&&365>a){h=e[c++];var d=e[c++],t=e[c++];a=((a&7)<<18|(h&63)<<12|(d&63)<<6|t&63)-65536;f[b++]=String.fromCharCode(55296+(a>>10));f[b++]=String.fromCharCode(56320+(a&1023))}else h=e[c++],d=e[c++],f[b++]=String.fromCharCode((a&15)<<12|(h&63)<<6|d&63)}return f.join("")};d.XORByteArray=
...
b),a=0;a<c.length;a++){var f=c[a];void 0!==f&&null!==f&&e.foreach(b,function(a,b){a=a.split("-");for(var c=1;c<a.length;c++)a[c]=a[c].charAt(0).toUpperCase()+a[c].slice(1);a=a.join("");f.style[a]!==b&&(f.style[a]=b)})}}})(chatease);(function(d){var f=d.utils;f.filter=function(e){var d="";this.replace=function(b){return d&&c?b.replace(c,"**"):b};if("string"==f.typeOf(e)&&e){d=e;var c=new RegExp(d,"ig")}}})(chatease);
...
(function(d){var f=d.utils;d.events.eventdispatcher=function(e){function g(a,b,c){if(a)for(var e=0;e<a.length;e++){var h=a[e];if(h){null!==h.count&&0===--h.count&&delete a[e];try{h.listener(b)}catch(r){f.log('Error handling "'+c+'" event listener ['+e+"]: "+r.toString(),h.listener,b)}}}}var c={},b=[];this.addEventListener=function(a,b,e){try{f.exists(c[a])||(c[a]=[]),"string"===f.typeOf(b)&&(b=(new Function("return "+b))()),c[a].push({listener:b,count:e||null})}catch(t){f.log("error",t)}return!1};
this.removeEventListener=function(a,b){if(c[a]){try{if(void 0===b){c[a]=[];return}var e;for(e=0;e<c[a].length;e++)if(c[a][e].listener.toString()===b.toString()){c[a].splice(e,1);break}}catch(t){f.log("error",t)}return!1}};this.addGlobalListener=function(a,c){try{"string"===f.typeOf(a)&&(a=(new Function("return "+a))()),b.push({listener:a,count:c||null})}catch(k){f.log("error",k)}return!1};this.removeGlobalListener=function(a){if(a){try{var c;for(c=b.length-1;0<=c;c--)b[c].listener.toString()===a.toString()&&
b.splice(c,1)}catch(k){f.log("error",k)}return!1}};this.dispatchEvent=function(a,h){h||(h={});f.extend(h,{id:e,version:d.version,type:a});"events"===d.debug&&f.log(a,h);g(c[a],h,a);g(b,h,a)}}})(chatease);
(function(d){var f=d.utils,e=d.events;f.timer=function(d,c){function b(){k++;a.dispatchEvent(e.CHATEASE_TIMER);0<a.repeatCount&&k>=a.repeatCount&&(a.stop(),a.dispatchEvent(e.CHATEASE_TIMER_COMPLETE))}var a=f.extend(this,new e.eventdispatcher("utils.timer")),h,k=0,g=!1;a.start=function(){!1===g&&(h=setInterval(b,a.delay),g=!0)};a.stop=function(){g&&(clearInterval(h),h=0,g=!1)};a.reset=function(){a.stop();k=0};a.currentCount=function(){return k};a.running=function(){return g};a.delay=d||50;a.repeatCount=
c||0}})(chatease);
...
a+" .cha-render .cha-console .nick",{color:"#5382E2","text-decoration":"none"});b("."+a+" .cha-render .cha-console ."+h[g.SYSTEM]+", ."+a+" .cha-render .cha-console ."+h[g.SYSTEM]+" .nick",{color:"#33CC00",cursor:"default","pointer-events":"none"});b("."+a+" .cha-render .cha-console .context",{"word-wrap":"break-word",display:"inline"});b("."+a+" .cha-render .cha-controls",{height:"40px",right:"0",bottom:"60px",left:"0",position:"absolute",overflow:"hidden","line-height":"100%","background-color":"inherit"});
b("."+a+" .cha-render .cha-controls > *",{margin:"8px 0","text-align":"center","line-height":"24px",display:"block"});b("."+a+" .cha-render .cha-controls .shieldtext",{"float":"left"});b("."+a+" .cha-render .cha-controls .shieldtext .icon",{padding:"5px"});b("."+a+" .cha-render .cha-controls .clearscreen",{"float":"right",width:"50px"});b("."+a+" .cha-render .cha-dialog",{height:"60px",right:"0",bottom:"0",left:"0",position:"absolute",overflow:"hidden","background-color":"#E0E0E0"});b("."+a+" .cha-render .cha-dialog .more",
{display:"none"});b("."+a+" .cha-render .cha-dialog textarea",{padding:"6px 10px",width:k.config.width-90+"px",height:"48px",resize:"none",border:"0 none","background-color":"#E6E6E6"});b("."+a+" .cha-render .cha-dialog .send",{width:"50px",height:"100%",top:"0",right:"0",position:"absolute"})}})(chatease);
(function(d){var f=d.utils,e=d.events,g=d.core.message.roles;d=d.core.skins;var c=d.modes,b=f.css,a="cha-skin",h={0:"r-visitor",1:"r-normal",14:"r-vip",16:"r-assistant",32:"r-secretary",48:"r-anchor",64:"r-admin",128:"r-suadmin",192:"r-system"};d.mobile=function(d){var k=f.extend(this,new e.eventdispatcher("skins.mobile"));k.resize=function(a,c){a=document.getElementById(k.config.id);c=document.getElementById(k.config.id+"-input");b.style(c,{width:a.clientWidth-114+"px"})};k.name=c.MOBILE;k.config=
f.extend({},d);a+="-"+k.name;b(".cha-wrapper",{width:"100%",height:"100%","background-color":"#171717"});b(".cha-wrapper *",{margin:"0",padding:"0","font-family":"Microsoft YaHei,arial,sans-serif","font-size":"14px","font-weight":"normal","box-sizing":"content-box"});b("."+a+" .cha-checkbox",{color:"#E6E6E6",cursor:"pointer"});b("."+a+" .cha-checkbox .icon",{"float":"left",padding:"0 5px",width:"14px",height:"14px","background-repeat":"no-repeat","background-position":"center","background-image":"url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAA4AAAAOAgMAAABiJsVCAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAAJUExURUxpcebm5ubm5kbBEu0AAAACdFJOUwCgoEVu0AAAABpJREFUCNdjYAABqVWrHBi0Vq1qII0AawMBACnPF0kf/g8sAAAAAElFTkSuQmCC)",
display:"inline-block"});b("."+a+" .cha-checkbox.checked .icon",{"background-image":"url(data:image/png;base64,)"});b("."+
a+" .cha-button",{padding:"0 10px","font-style":"normal","font-weight":"normal","text-align":"center","text-transform":"uppercase","white-space":"nowrap","word-spacing":"normal",border:"none","border-radius":"2px",cursor:"pointer",display:"inline-block","-webkit-font-smoothing":"subpixel-antialiased","-moz-osx-font-smoothing":"grayscale",transition:"150ms ease-in-out","transition-property":"background-color, color"});b("."+a+" .cha-button.red",{color:"#FFFFFF","background-color":"#FF0046"});b("."+
a+" .cha-button.red:hover",{"background-color":"#97052D"});b("."+a+" .cha-button.blue",{color:"#FFFFFF","background-color":"#0B7EF4"});b("."+a+" .cha-button.blue:hover",{"background-color":"#0966C3"});b("."+a+" .cha-button.white",{color:"#000000","background-color":"#FFFFFF"});b("."+a+" .cha-button.white:hover",{"background-color":"#E0E0E0"});b("."+a+" .cha-button.gray",{color:"#000000","background-color":"#E0E0E0"});b("."+a+" .cha-button.gray:hover",{"background-color":"#96A0B4"});b("."+a+" .cha-render",
{width:"100%",height:"100%",position:"relative",overflow:"hidden"});b("."+a+" .cha-render object",{width:"0",height:"0",position:"absolute"});b("."+a+" .cha-render .cha-title",{width:"100%",height:"40px","font-family":"inherit","font-weight":"normal","text-align":"center","line-height":"40px",color:"#E6E6E6","background-color":"inherit",cursor:"default","pointer-events":"none"});b("."+a+" .cha-render .cha-console",{color:"#242424",top:(k.config.title?40:0)+"px",right:"0",bottom:"40px",left:"0",position:"absolute",
"background-color":"#F8F8F8","overflow-x":"hidden","overflow-y":k.config.smoothing?"hidden":"scroll"});b("."+a+" .cha-render.more .cha-console",{bottom:"130px"});b("."+a+" .cha-render .cha-console > div",{padding:"0 6px "+(k.config.smoothing?"6px":"0")+" 6px"});b("."+a+" .cha-render .cha-console > div > div",{margin:"6px 0","line-height":"20px"});b("."+a+" .cha-render .cha-console .user",{cursor:"pointer"});b("."+a+" .cha-render .cha-console .area",{"margin-right":"2px","vertical-align":"middle"});
...
{color:"#F76767","border-color":"#F76767"});b("."+a+" .cha-render .cha-console .nick",{color:"#5382E2","text-decoration":"none"});b("."+a+" .cha-render .cha-console ."+h[g.SYSTEM]+", ."+a+" .cha-render .cha-console ."+h[g.SYSTEM]+" .nick",{color:"#33CC00",cursor:"default","pointer-events":"none"});b("."+a+" .cha-render .cha-console .context",{"word-wrap":"break-word",display:"inline"});b("."+a+" .cha-render .cha-controls",{margin:"0",padding:"0",height:"90px",bottom:"-90px",right:"0",left:"0",position:"absolute",
...
display:"block"});b("."+a+" .cha-render .cha-dialog textarea",{margin:"5px 0",padding:"5px",width:k.config.width-114+"px",height:"20px",resize:"none",border:"0 none","line-height":"20px","background-color":"#F8F8F8"});b("."+a+" .cha-render .cha-dialog .send",{"float":"right",margin:"5px",padding:"0 5px",width:"50px",height:"30px",top:"0",right:"0",position:"absolute"})}})(chatease);(function(d){(d.core.renders={}).modes={DEFAULT:"def",NONE:"none"}})(chatease);
(function(d){var f=d.utils,e=d.events,g=d.core,c=g.message,b=c.modes,a=c.roles;g=g.renders;var h=g.modes,k=f.css,t={0:"uni",1:"",2:""},C={0:"r-visitor",1:"r-normal",2:"r-vip1",4:"r-vip2",6:"r-vip3",8:"r-vip4",10:"r-vip5",12:"r-vip6",14:"r-vip7",16:"r-assistant",32:"r-secretary",48:"r-anchor",64:"r-admin",128:"r-suadmin",192:"r-system"},r={0:"[\u5bc6\u8bed]",1:"",2:""},v={0:"",1:"",2:"VIP1",4:"VIP2",6:"VIP3",8:"VIP4",10:"VIP5",12:"VIP6",14:"VIP7",16:"\u52a9\u7406",32:"\u79d8\u4e66",48:"\u4e3b\u64ad",
...
l.dispatchEvent(a,f.extend({value:c},b))}}(c,e);try{h.addEventListener("click",a)}catch(M){h.attachEvent("onclick",a)}return h}function q(a,b,c,e){b=f.createElement("div",b);b.innerHTML='<span class="icon"></span>'+a;a=function(a,b){return function(c){l.dispatchEvent(a,b)}}(c,e);try{b.addEventListener("click",a)}catch(J){b.attachEvent("onclick",a)}return b}function H(b){var c=0;if("number"!=f.typeOf(b)&&(b=parseInt(b),NaN==b||0>b))return c;b&a.SYSTEM?c=b&a.SYSTEM:b&a.ANCHOR?c=b&a.ANCHOR:b&a.VIP?c=
b&a.VIP:b&a.NORMAL&&(c=a.NORMAL);return c}var l=f.extend(this,new e.eventdispatcher("renders.def")),A={title:"CHATEASE "+d.version},p,u,n,B,D,E,F,G,w,m,K;l.setup=function(){f.isMSIE("(8|9)")?_object.setup&&(_object.setup(l.config),l.dispatchEvent(e.CHATEASE_READY,{id:l.config.id})):l.dispatchEvent(e.CHATEASE_READY,{id:l.config.id})};l.show=function(c,d,h){var g=H(c.role),k=f.createElement("div",C[g]),m=r[h&127];if(m&&g!=a.SYSTEM){var p=f.createElement("span","area "+t[h&127]);p.innerHTML=m;k.appendChild(p)}m=
f.createElement("span","user");k.appendChild(m);c.icon&&(p=f.createElement("img","icon"),p.src=c.icon,m.appendChild(p));if(g=v[g])p=f.createElement("span","role"),p.innerHTML=g,m.appendChild(p);g=f.createElement("a","nick");g.innerHTML=c.name+": ";m.appendChild(g);c=function(a){return function(b){w.value="/r "+a.name+" ";l.dispatchEvent(e.CHATEASE_VIEW_NICKCLICK,{user:a})}}(c);try{m.addEventListener("click",c)}catch(N){m.attachEvent("onclick",c)}c=f.createElement("div","context");c.innerHTML="<span>"+
d+"</span>";k.appendChild(c);n.childNodes.length>=l.config.maxrecords&&n.removeChild(n.childNodes[0]);h&b.OUTDATED?n.insertBefore(k,n.childNodes[0]):n.appendChild(k);l.config.smoothing?l.refresh():u.scrollTop=u.scrollHeight};l.send=function(){l.dispatchEvent(e.CHATEASE_VIEW_SEND,{data:{data:w.value,mode:b.MULTI}});l.clearInput()};l.refresh=function(){l.config.smoothing?(u.clientHeight<n.clientHeight&&k.style(n,{"transition-timing-function":"cubic-bezier(0.165, 0.84, 0.44, 1)","transition-duration":"100ms",
transform:"translate(0px, "+(u.clientHeight-n.clientHeight)+"px) translateZ(0px)"}),K.refresh()):u.scrollTop=u.scrollHeight};l.clearInput=function(){w.value=""};l.clearScreen=function(){f.emptyElement(n)};l.element=function(){return _object};l.resize=function(a,b){};l.destroy=function(){};l.name=h.DEFAULT;l.config=f.extend({},A,g);f.isMSIE("(8|9)")&&(c.innerHTML='<object id="cha-swf" name="cha-swf" align="middle" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"><param name="movie" value="'+l.config.swf+
'"><param name="quality" value="high"><param name="bgcolor" value="#ffffff"><param name="allowscriptaccess" value="sameDomain"><param name="allowfullscreen" value="true"><param name="wmode" value="transparent"><param name="FlashVars" value="id='+l.config.id+'"></object>',_object=l.WebSocket=c.firstChild);(function(){l.config.title&&(p=f.createElement("div","cha-title"),c.appendChild(p),p.innerHTML=l.config.title);u=f.createElement("div","cha-console");u.id=l.config.id+"-console";c.appendChild(u);
n=f.createElement("div","cha-content");u.appendChild(n);l.config.smoothing&&(K=new BScroll(u));B=f.createElement("div","cha-controls");c.appendChild(B);E=z("\u5c4f\u853d\u6d88\u606f","cha-checkbox shieldtext",e.CHATEASE_VIEW_PROPERTY,{key:"shield"},!1);E.id=l.config.id+"-shieldtext";B.appendChild(E);F=q("\u6e05\u5c4f","cha-button white clearscreen",e.CHATEASE_VIEW_CLEARSCREEN,null);B.appendChild(F);D=f.createElement("div","cha-dialog");c.appendChild(D);G=z("","more",e.CHATEASE_VIEW_PROPERTY,{key:"more"},
!1);D.appendChild(G);w=f.createElement("textarea");w.id=l.config.id+"-input";D.appendChild(w);m=f.createElement("button","cha-button blue send");D.appendChild(m);w.setAttribute("placeholder","\u8f93\u5165\u804a\u5929\u5185\u5bb9");l.config.maxlength&&w.setAttribute("maxlength",l.config.maxlength);var a=function(){return function(a){a=window.event||a;13==a.keyCode&&(a.ctrlKey?w.value+="\r\n":(l.send(),window.event?a.returnValue=!1:a.preventDefault()))}}();try{w.addEventListener("keypress",a)}catch(L){w.attachEvent("onkeypress",
a)}m.innerHTML="\u53d1\u9001";a=function(){return function(){l.send()}}();try{m.addEventListener("click",a)}catch(L){m.attachEvent("onclick",a)}})()}})(chatease);
...
(function(d){var f=d.utils,e=f.css,g=d.events,c=d.core,b=c.message.roles,a=d.core.skins.modes,h="cha-skin",k="cha-bubble",t={0:"r-visitor",1:"r-normal",14:"r-vip",16:"r-assistant",32:"r-secretary",48:"r-anchor",64:"r-admin",128:"r-suadmin",192:"r-system"};c.components.bubble=function(c){var d=f.extend(this,new g.eventdispatcher("components.bubble")),C={name:"",skin:a.DEFAULT};d.resize=function(a,b){};d.config=f.extend({},C,c);d.config.name&&(h+="-"+d.config.skin,k+="-"+d.config.name,e("."+h+"."+k+
" .cha-render .cha-console .area, ."+h+"."+k+" .cha-render .cha-console .role",{}),e("."+h+"."+k+" .cha-render .cha-console .icon",{"float":"left","margin-top":"4px",width:"32px",height:"32px"}),e("."+h+"."+k+" .cha-render .cha-console .context",{margin:"4px 0 10px 36px",display:"block"}),e("."+h+"."+k+" .cha-render .cha-console .context span",{padding:"8px 12px","border-radius":"5px","background-color":"#D9DDD4",display:"inline-block"}),e("."+h+"."+k+" .cha-render .cha-console ."+t[b.SYSTEM]+" .context",
{margin:"0",display:"inline-block"}),e("."+h+"."+k+" .cha-render .cha-console ."+t[b.SYSTEM]+" .context span",{padding:"0","border-radius":"0","background-color":"inherit"}))}})(chatease);
(function(d){var f=d.utils,e=d.events,g=d.core;g.entity=function(c){var b=f.extend(this,new e.eventdispatcher("core.entity")),a,d,k;b.setup=function(){setTimeout(function(){k.setup()},0)};b.destroy=function(){k&&k.stop();d&&d.destroy();a&&a.destroy()};b.id=c.id;b.model=a=new g.model(c);b.view=d=new g.view(a);b.controller=k=new g.controller(a,d);k.addGlobalListener(function(a){b.dispatchEvent(a.type,a)});b.onSWFOpen=k.onOpen;b.onSWFMessage=k.onMessage;b.onSWFError=k.onError;b.onSWFClose=k.onClose;
b.send=k.send;b.close=k.close;b.getState=a.getState;b.resize=d.resize}})(chatease);
...
e,f){var d=c[a];void 0==d&&(d={},c[a]=d);d[b]={manager:e,until:Math.floor((new Date).getTime()/1E3)+f}};a.unfreeze=function(a,b){(a=c[a])&&delete a[b]};a.limited=function(a,b){if(a=c[a])if(b=a[b])return Math.floor((new Date).getTime()/1E3)<b.until;return!1};f.extend(a,{id:0,stat:0,group:0});var b={};var c={}};d.model=function(a){var d=f.extend(this,new e.eventdispatcher("core.model")),k=g.CLOSED;d.setState=function(a){a!==k&&(k=a,d.dispatchEvent(e.CHATEASE_STATE,{state:a}))};d.getState=function(){return k};
d.setProperty=function(a,b){1==t.hasOwnProperty(a)&&(t[a]=b,d.dispatchEvent(e.CHATEASE_PROPERTY,{key:a,value:b}))};d.getProperty=function(a){return t[a]};d.getConfig=function(a){return d.config[a]};d.destroy=function(){};d.config=f.extend({},{},a);var t={user:new c,channel:new b,shield:!1}}})(chatease);
(function(d){var f=d.utils,e=d.events;d=d.core;var g=d.message.roles,c=d.components,b=d.renders,a=b.modes,h=d.skins;d.view=function(d){function k(a){if(a.ctrlKey||a.metaKey)return!0;switch(a.keyCode){case 13:l&&l.send()}if(/13/.test(a.keyCode))return a.preventDefault?a.preventDefault():a.returnValue=!1,!1}function C(a){q.resize()}function r(a){switch(a.key){case "more":a.value?f.addClass(y,"more"):f.removeClass(y,"more");l.refresh();break;case "shield":var b=a.value?"\u53d6\u6d88\u5c4f\u853d":"\u5c4f\u853d\u6d88\u606f";
document.getElementById(d.getConfig("id")+"-shieldtext").innerHTML='<span class="icon"></span>'+b}z(a)}function v(a){z(a)}function z(a){q.dispatchEvent(a.type,a)}var q=f.extend(this,new e.eventdispatcher("core.view")),x,y,H,l,A;q.setup=function(){l?(l.setup(),q.resize()):q.dispatchEvent(e.CHATEASE_SETUP_ERROR,{message:"Render not available!",name:d.config.render.name})};q.show=function(a,b,c){l&&(a.role&g.SYSTEM||!d.getProperty("shield"))&&l.show(a,b,c)};q.resize=function(a,b){setTimeout(function(){l&&
l.resize(a,b);A&&A.resize(a,b)},0)};q.destroy=function(){x&&x.removeEventListener("keydown",k);l&&l.destroy()};(function(){x=f.createElement("div","cha-wrapper cha-skin-"+d.getConfig("skin").name+" cha-bubble-"+d.getConfig("bubble").name);x.id=d.getConfig("id");y=f.createElement("div","cha-render");H=f.createElement("div","cha-contextmenu");x.appendChild(y);x.appendChild(H);var g=f.extend({},d.getConfig("bubble"),{skin:d.getConfig("skin").name});try{new c.bubble(g)}catch(u){f.log('Failed to init "bubble" component!')}g=
f.extend({},d.getConfig("render"),{id:d.getConfig("id"),url:d.getConfig("url"),width:d.getConfig("width"),height:d.getConfig("height"),maxlength:d.getConfig("maxlength"),maxrecords:d.getConfig("maxrecords"),smoothing:d.getConfig("smoothing")});try{l=q.render=new b[g.name](y,g),l.addEventListener(e.CHATEASE_READY,z),l.addEventListener(e.CHATEASE_VIEW_SEND,z),l.addEventListener(e.CHATEASE_VIEW_PROPERTY,r),l.addEventListener(e.CHATEASE_VIEW_CLEARSCREEN,z),l.addEventListener(e.CHATEASE_VIEW_NICKCLICK,
z),l.addEventListener(e.CHATEASE_RENDER_ERROR,v)}catch(u){f.log("Failed to init render "+g.name+"!")}g=f.extend({},d.getConfig("skin"),{id:d.getConfig("id"),width:d.config.width,height:d.config.height,title:!!l.config.title,smoothing:d.getConfig("smoothing")});try{A=new h[g.name](g)}catch(u){f.log("Failed to init skin "+g.name+"!")}if(!l||l.name!=a.NONE){g=document.getElementById(d.getConfig("id"));g.parentNode.replaceChild(x,g);try{x.addEventListener("keydown",k),window.addEventListener("resize",
C)}catch(u){x.attachEvent("onkeydown",k),window.attachEvent("onresize",C)}}})()}})(chatease);
(function(d){var f=d.utils,e=f.crypt,g=d.events,c=d.core,b=c.states,a=c.message,h=a.keys,k=a.cmds,t=a.opts,C=a.modes,r=a.status,v={id:-1,name:"[\u7cfb\u7edf]",role:a.roles.SYSTEM};c.controller=function(c,q){function x(){if(n){if(c.getState()==b.CONNECTED){f.log("Websocket had connected already.");return}n.readyState!=WebSocket.CONNECTING&&n.readyState!=WebSocket.OPEN||n.close()}q.render.clearScreen();d.debug?q.show(v,"\u804a\u5929\u5ba4\u8fde\u63a5\u4e2d\u2026"):f.log("\u804a\u5929\u5ba4\u8fde\u63a5\u4e2d\u2026");
try{window.WebSocket=window.WebSocket||window.MozWebSocket,window.WebSocket?(n=new WebSocket(c.config.url,"binary"),n.binaryType="arraybuffer",n.onopen=p.onOpen,n.onmessage=p.onMessage,n.onerror=p.onError,n.onclose=p.onClose):(n=q.render.WebSocket,n.connect())}catch(m){f.log("Failed to initialize websocket: "+m),y(r.NOT_ACCEPTABLE,null)}}function y(a,b){var c=z(a);c&&q.show(v,c);var d={raw:"error",error:{code:a,status:c}};f.foreach(b,function(a,b){"cmd"!=a&&"raw"!=a&&"error"!=a&&(d[a]=b)});p.dispatchEvent(g.ERROR,
d)}function z(a){var b="";switch(a){case r.BadRequest:b="\u9519\u8bef\u8bf7\u6c42\uff01";break;case r.Unauthorized:b="\u8bf7\u5148\u767b\u5f55\uff01";break;case r.Forbidden:b="\u6743\u9650\u9519\u8bef\uff01";break;case r.NotFound:b="\u672a\u77e5\u8bf7\u6c42\uff01";break;case r.NotAcceptable:b="\u65e0\u6cd5\u8bc6\u522b\uff01";break;case r.RequestTimeout:b="\u8bf7\u6c42\u8d85\u65f6\uff01";break;case r.TooManyRequests:b="\u64cd\u4f5c\u9891\u7e41\uff01";break;case r.InternalServerError:b="\u5185\u90e8\u9519\u8bef\uff01";
break;case r.NotImplemented:b="\u65e0\u6cd5\u8bc6\u522b\uff01";break;case r.BadGateway:b="\u7f51\u5173\u9519\u8bef\uff01";break;case r.ServiceUnavailable:b="\u670d\u52a1\u8fc7\u8f7d\uff01";break;case r.GatewayTimeout:b="\u7f51\u5173\u8d85\u65f6\uff01"}return b}function l(a){B||(B=new f.timer(a,1),B.addEventListener(g.CHATEASE_TIMER,function(a){x()}));B.delay=a;B.reset();B.start()}function A(a){p.dispatchEvent(a.type,a)}var p=f.extend(this,new g.eventdispatcher("core.controller")),u=!1,n,B,D,E=0;p.setup=
function(a){u||q.setup()};p.send=function(a,d){if(n&&c.getState()==b.CONNECTED)if("object"!=f.typeOf(a)||0==a.hasOwnProperty(h.CMD)||0==a.hasOwnProperty(h.DATA))y(r.BadRequest,a);else{var g=c.getProperty("user");if(g.limited())y(r.TooManyRequests,a);else{var k=c.getProperty("channel");if(g.role<k.stat||k.limited(g.id,t.MUTE))y(r.Forbidden,a);else{d&&(G++,F[G]=d,a.seq=G);a=JSON.stringify(a);try{var m=e.stringToUTF8ByteArray(a),l=new Uint8Array(m);n.send(l.buffer);return}catch(J){}try{n.send(a)}catch(J){}}}}else x()};
p.onOpen=function(a){c.setState(b.CONNECTED)};p.onMessage=function(b){var l=b.data;"arraybuffer"===f.typeOf(b.data)&&(l=new Uint8Array(b.data),l=e.UTF8ByteArrayToString(l));try{var m=eval("("+l+")")}catch(I){f.log("Failed to parse JSON. \nError: "+I+"\ndata: "+b.data);return}m.hasOwnProperty(h.SEQ)&&F.hasOwnProperty(m.seq)&&(b=F[m.seq],l=b.result,m.cmd==k.ERROR&&(l=b.status),l&&l.call(null,m),delete F[m.seq]);b=c.getProperty("user");l=c.getProperty("channel");switch(m.cmd){case k.INFO:b.update(f.extend({},
m.user));l.update(f.extend({},m.channel));d.debug?q.show(v,"\u5df2\u52a0\u5165\u623f\u95f4\uff08"+l.id+"\uff09\u3002"):f.log("\u5df2\u52a0\u5165\u623f\u95f4\uff08"+l.id+"\uff09\u3002");b.role<l.stat&&q.show(v,"\u60a8\u6240\u5728\u7684\u7528\u6237\u7ec4\u4e0d\u80fd\u53d1\u8a00\uff01");p.dispatchEvent(g.CHATEASE_INFO,m);break;case k.TEXT:try{D||(D=new f.filter(c.config.keywords)),m.data=D.replace(m.data)}catch(I){f.log("Failed to execute filter.")}l.add(m.user);q.show(m.user,m.data,m.mode);p.dispatchEvent(g.CHATEASE_MESSAGE,
m);break;case k.USER:p.dispatchEvent(g.CHATEASE_USER,m);break;case k.JOIN:l.add(m.user);q.show(m.user,m.user.name+" \u8fdb\u5165\u623f\u95f4\u3002");p.dispatchEvent(g.CHATEASE_JOIN,m);break;case k.LEFT:l.remove(m.user);q.show(m.user,m.user.name+" \u79bb\u5f00\u623f\u95f4\u3002");p.dispatchEvent(g.CHATEASE_LEFT,m);break;case k.CTRL:var n=a.parseControl(m.data);if(n){var r=n[0];n=n[1];0==n?l.unfreeze(m.sub,r):l.freeze(m.sub,r,m.user,n);if(m.sub==b.id)switch(r){case t.MUTE:q.show(v,"\u60a8\u5df2\u88ab"+
(n?"":"\u89e3\u9664")+"\u7981\u8a00"+(n?n+"\u79d2":"")+"\u3002");break;case t.FORBID:q.show(v,"\u60a8\u5df2\u88ab\u9650\u5236\u8fdb\u5165\u8be5\u623f\u95f4"+n+"\u79d2\u3002"),c.config.maxretries=0,p.close()}}break;case k.EXTERN:p.dispatchEvent(g.CHATEASE_EXTERN,m);break;case k.ERROR:y(m.error.code,m);break;default:f.log("Unknown cmd: "+m.cmd+", ignored.")}};p.onError=function(a){c.setState(b.ERROR)};p.onClose=function(a){c.setState(b.CLOSED)};p.close=function(){n&&n.close()};var F={};var G=0;var w=
...
(function(d){var f=d.utils,e=d.events,g=d.embed=function(c){function b(b){switch(b.type){case e.ERROR:case e.CHATEASE_SETUP_ERROR:case e.CHATEASE_RENDER_ERROR:a.errorScreen(b.message);a.dispatchEvent(e.ERROR,b);break;default:a.dispatchEvent(b.type,b)}}var a=f.extend(this,new e.eventdispatcher("embed")),h={},k=null,t=!1;a.embed=function(){try{h=new g.config(c.config),k=new g.embedder(c,h)}catch(C){f.log("Failed to init embedder!");a.dispatchEvent(e.CHATEASE_SETUP_ERROR,{message:"Failed to init embedder!",
render:h.render.name});return}k.addGlobalListener(b);k.embed()};a.errorScreen=function(a){t||(t=!0,d.api.displayError(a,h))};(function(){f.foreach(c.config.events,function(a,b){a=c[a];"function"===f.typeOf(a)&&a.call(c,b)})})()}})(chatease);
