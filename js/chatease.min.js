chatease=function(){if(chatease.api)return chatease.api.getInstance.apply(this,arguments)};chatease.version="1.1.04";
...
(function(d){var f=d.utils,e=d.events,g=d.core,c=g.message,b=c.modes,a=c.roles;g=g.renders;var h=g.modes,n=f.css,m={0:"uni",1:"",2:"",3:"outdated"},G={0:"r-visitor",1:"r-normal",14:"r-vip",16:"r-assistant",32:"r-secretary",48:"r-anchor",64:"r-admin",128:"r-suadmin",192:"r-system"},v={0:"[\u5bc6\u8bed]",1:"",2:"",3:"[\u5386\u53f2]"},w={0:"",1:"",14:"VIP",16:"\u52a9\u7406",32:"\u79d8\u4e66",48:"\u4e3b\u64ad",64:"\u7ba1\u7406\u5458",128:"\u8d85\u7ba1",192:""};CSS_SMOOTH_EASE="opacity .25s ease";CSS_100PCT=
"100%";CSS_ABSOLUTE="absolute";CSS_IMPORTANT=" !important";CSS_HIDDEN="hidden";CSS_NONE="none";CSS_BLOCK="block";g.def=function(c,g){function x(a,b,c,e,h){var d=f.createElement("div",b);d.setAttribute("value",!!h);d.innerHTML='<span class="icon"></span>'+a;a=function(a,b){return function(c){c="true"==d.getAttribute("value")?!1:!0;d.setAttribute("value",c);c?f.addClass(d,"checked"):f.removeClass(d,"checked");k.dispatchEvent(a,f.extend({value:c},b))}}(c,e);try{d.addEventListener("click",a)}catch(M){d.attachEvent("onclick",
a)}return d}function p(a,b,c,e){b=f.createElement("div",b);b.innerHTML='<span class="icon"></span>'+a;a=function(a,b){return function(c){k.dispatchEvent(a,b)}}(c,e);try{b.addEventListener("click",a)}catch(K){b.attachEvent("onclick",a)}return b}function u(b){var c=0;if("number"!=f.typeOf(b)&&(b=parseInt(b),NaN==b||0>b))return c;b&a.SYSTEM?c=b&a.SYSTEM:b&a.ANCHOR?c=b&a.ANCHOR:b&a.VIP?c=a.VIP:b&a.NORMAL&&(c=a.NORMAL);return c}var k=f.extend(this,new e.eventdispatcher("renders.def")),D={title:"CHATEASE "+
d.version},t,z,q,A,C,E,F,H,y,l,r;k.setup=function(){f.isMSIE("(8|9)")?_object.setup&&(_object.setup(k.config),k.dispatchEvent(e.CHATEASE_READY,{id:k.config.id})):k.dispatchEvent(e.CHATEASE_READY,{id:k.config.id})};k.show=function(c,h,d){var g=u(c.role),l=f.createElement("div",G[g]),n=v[d];if(n&&g!=a.SYSTEM){var r=f.createElement("span","area "+m[d]);r.innerHTML=n;l.appendChild(r)}n=f.createElement("span","user");l.appendChild(n);c.icon&&(r=f.createElement("img","icon"),r.src=c.icon,n.appendChild(r));
if(g=w[g])r=f.createElement("span","role"),r.innerHTML=g,n.appendChild(r);g=f.createElement("a","nick");g.innerHTML=c.name+": ";c=function(a){return function(b){y.value="/r "+a.name+" ";k.dispatchEvent(e.CHATEASE_VIEW_NICKCLICK,{user:a})}}(c);try{n.addEventListener("click",c)}catch(N){n.attachEvent("onclick",c)}n.appendChild(g);r=f.createElement("span","context");r.innerHTML=h;l.appendChild(r);q.childNodes.length>=k.config.maxrecords&&q.removeChild(q.childNodes[0]);d==b.OUTDATED?q.insertBefore(l,
q.childNodes[0]):q.appendChild(l);k.config.smoothing?k.refresh():z.scrollTop=z.scrollHeight};k.send=function(){k.dispatchEvent(e.CHATEASE_VIEW_SEND,{data:{data:y.value,mode:b.MULTI}});k.clearInput()};k.refresh=function(){k.config.smoothing?(z.clientHeight<q.clientHeight&&n.style(q,{"transition-timing-function":"cubic-bezier(0.165, 0.84, 0.44, 1)","transition-duration":"100ms",transform:"translate(0px, "+(z.clientHeight-q.clientHeight)+"px) translateZ(0px)"}),r.refresh()):z.scrollTop=z.scrollHeight};
k.clearInput=function(){y.value=""};k.clearScreen=function(){f.emptyElement(q)};k.element=function(){return _object};k.resize=function(a,b){};k.destroy=function(){};k.name=h.DEFAULT;k.config=f.extend({},D,g);f.isMSIE("(8|9)")&&(c.innerHTML='<object id="cha-swf" name="cha-swf" align="middle" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"><param name="movie" value="'+k.config.swf+'"><param name="quality" value="high"><param name="bgcolor" value="#ffffff"><param name="allowscriptaccess" value="sameDomain"><param name="allowfullscreen" value="true"><param name="wmode" value="transparent"><param name="FlashVars" value="id='+
