chatease=function(){if(chatease.api)return chatease.api.getInstance.apply(this,arguments)};chatease.version="1.0.36";
...
this.removeEventListener=function(b,e){if(a[b]){try{if(void 0===e){a[b]=[];return}var d;for(d=0;d<a[b].length;d++)if(a[b][d].listener.toString()===e.toString()){a[b].splice(d,1);break}}catch(r){f.log("error",r)}return!1}};this.addGlobalListener=function(a,e){try{"string"===f.typeOf(a)&&(a=(new Function("return "+a))()),b.push({listener:a,count:e||null})}catch(l){f.log("error",l)}return!1};this.removeGlobalListener=function(a){if(a){try{var d;for(d=b.length-1;0<=d;d--)b[d].listener.toString()===a.toString()&&
...
var h=f.extend(this,new e.eventdispatcher("renders.def")),y,t,m,A,B,x,n,z,q;h.setup=function(){f.isMSIE("(8|9)")?_object.setup&&(_object.setup(h.config),h.dispatchEvent(e.CHATEASE_READY,{id:h.config.id})):h.dispatchEvent(e.CHATEASE_READY,{id:h.config.id})};h.show=function(d,c,k){"object"!=f.typeOf(c)&&(c={id:0,name:"\u7cfb\u7edf",role:b.SYSTEM});var g=f.createElement("div");(c.role&b.SYSTEM)==b.SYSTEM&&(g.className="cha-system");var l=p(c.icon);l&&g.appendChild(l);k==a.UNI&&(l=f.createElement("span",
...
e=0};c.model=function(a){var c=f.extend(this,new e.eventdispatcher("core.model")),d=g.CLOSED,r;c.setState=function(a){a!==d&&(d=a,c.dispatchEvent(e.CHATEASE_STATE,{state:a}))};c.getState=function(){return d};c.setProperty=function(a,b){1==r.hasOwnProperty(a)&&(r[a]=b,c.dispatchEvent(e.CHATEASE_PROPERTY,{key:a,value:b}))};c.getProperty=function(a){return r[a]};c.getConfig=function(a){return c.config[a]};c.destroy=function(){};c.config=f.extend({},{},a);r={userlist:{},userinfo:new b,shield:!1}}})(chatease);
...
document.getElementById(c.getConfig("id")+"-shieldtext").innerHTML='<span class="icon"></span>'+b}p(a)}function D(a){p(a)}function p(a){w.dispatchEvent(a.type,a)}var w=f.extend(this,new e.eventdispatcher("core.view")),h,y,t,m,A;w.setup=function(){m?(m.setup(),w.resize()):w.dispatchEvent(e.CHATEASE_SETUP_ERROR,{message:"Render not available!",name:c.config.render.name})};w.show=function(a,b,d){(!b||b.role&g.SYSTEM||!c.getProperty("shield"))&&m&&m.show(a,b,d)};w.resize=function(a,b){setTimeout(function(){m&&
m.resize(a,b);A&&A.resize(a,b)},0)};w.destroy=function(){h&&h.removeEventListener("keydown",l);m&&m.destroy()};(function(){h=f.createElement("div","cha-wrapper cha-skin-"+c.getConfig("skin").name);h.id=c.getConfig("id");y=f.createElement("div","cha-render");t=f.createElement("div","cha-contextmenu");h.appendChild(y);h.appendChild(t);var g=f.extend({},c.getConfig("render"),{id:c.getConfig("id"),url:c.getConfig("url"),width:c.getConfig("width"),height:c.getConfig("height"),maxlength:c.getConfig("maxlength"),
...
(function(c){var f=c.utils,e=f.crypt,g=c.events,a=c.core,b=a.states,d=a.protocol,k=d.cmds,l=d.raws,r=d.types,u=d.roles,D=d.punishments,p=d.errors;a.controller=function(a,d){function h(){if(q){if(a.getState()==b.CONNECTED){f.log("Websocket had connected already.");return}q.readyState!=WebSocket.CONNECTING&&q.readyState!=WebSocket.OPEN||q.close()}d.render.clearScreen();c.debug?d.show("\u804a\u5929\u5ba4\u8fde\u63a5\u4e2d\u2026"):f.log("\u804a\u5929\u5ba4\u8fde\u63a5\u4e2d\u2026");try{window.WebSocket=
window.WebSocket||window.MozWebSocket,window.WebSocket?(q=new WebSocket(a.config.url,"binary"),q.binaryType="arraybuffer",q.onopen=n.onOpen,q.onmessage=n.onMessage,q.onerror=n.onError,q.onclose=n.onClose):(q=d.render.WebSocket,q.connect())}catch(v){f.log("Failed to initialize websocket: "+v),m(p.NOT_ACCEPTABLE,null)}}function t(a){var b="";if("number"!=f.typeOf(a)&&(a=parseInt(a),NaN==a||0>a))return"";a&u.SYSTEM?b=(a&u.SYSTEM)==u.SYSTEM?b+"[\u7cfb\u7edf]":a&u.SU_ADMIN?b+"[\u8d85\u7ba1]":b+"[\u7ba1\u7406\u5458]":
a&u.ANCHOR?b=(a&u.ANCHOR)==u.ANCHOR?b+"[\u4e3b\u64ad]":a&u.SECRETARY?b+"[\u52a9\u7406]":b+"[\u623f\u7ba1]":a&u.VIP?b+="[VIP"+((a&u.VIP)-1)+"]":(a&u.NORMAL)!=u.NORMAL&&(b+="[\u6e38\u5ba2]");return b}function m(a,b){var c=w(a);c&&d.show(c);var e={raw:"error",error:{code:a,explain:c}};f.foreach(b,function(a,b){"cmd"!=a&&"raw"!=a&&"error"!=a&&(e[a]=b)});n.dispatchEvent(g.ERROR,e)}function w(a){var b="";switch(a){case p.BAD_REQUEST:b="\u9519\u8bef\u8bf7\u6c42\uff01";break;case p.UNAUTHORIZED:b="\u8bf7\u5148\u767b\u5f55\uff01";
break;case p.FORBIDDEN:b="\u6743\u9650\u9519\u8bef\uff01";break;case p.NOT_FOUND:b="\u672a\u77e5\u8bf7\u6c42\uff01";break;case p.NOT_ACCEPTABLE:b="\u65e0\u6cd5\u8bc6\u522b\uff01";break;case p.REQUEST_TIMEOUT:b="\u8bf7\u6c42\u8d85\u65f6\uff01";break;case p.CONFLICT:b="\u64cd\u4f5c\u9891\u7e41\uff01";break;case p.EXPECTATION_FAILED:b="\u64cd\u4f5c\u5931\u8d25\uff01";break;case p.INTERNAL_SERVER_ERROR:b="\u5185\u90e8\u9519\u8bef\uff01";break;case p.NOT_IMPLEMENTED:b="\u65e0\u6cd5\u8bc6\u522b\uff01";
break;case p.BAD_GATEWAY:b="\u54cd\u5e94\u65e0\u6548\uff01";break;case p.SERVICE_UNAVAILABLE:b="\u670d\u52a1\u8fc7\u8f7d\uff01";break;case p.GATEWAY_TIMEOUT:b="\u7f51\u5173\u8d85\u65f6\uff01"}return b}function B(a){C||(C=new f.timer(a,1),C.addEventListener(g.CHATEASE_TIMER,function(a){h()}));C.delay=a;C.reset();C.start()}function x(a){n.dispatchEvent(a.type,a)}var n=f.extend(this,new g.eventdispatcher("core.controller")),z=!1,q,C,E,F,H,G=0;n.setup=function(a){z||d.setup()};n.send=function(c,d){if(q&&
a.getState()==b.CONNECTED)if("object"!=f.typeOf(c)||0==c.hasOwnProperty("cmd"))m(p.BAD_REQUEST,c);else{var g=a.getProperty("userinfo");if(0==g.isActive())m(p.CONFLICT,c);else if(1==g.isMuted())m(p.EXPECTATION_FAILED,c);else{d&&(g=H++,F[g]=d,c.req=g);c=JSON.stringify(c);try{var l=e.stringToUTF8ByteArray(c),v=new Uint8Array(l);q.send(v.buffer);return}catch(J){}try{q.send(c)}catch(J){}}}else h()};n.onOpen=function(c){a.setState(b.CONNECTED)};n.onMessage=function(b){var k=b.data;"arraybuffer"===f.typeOf(b.data)&&
(k=new Uint8Array(b.data),k=e.UTF8ByteArrayToString(k));var h;try{h=eval("("+k+")")}catch(I){f.log("Failed to parse JSON. \nError: "+I+"\ndata: "+b.data);return}h.hasOwnProperty("req")&&F.hasOwnProperty(h.req)&&(b=F[h.req],k=b.result,h.raw==l.ERROR&&(k=b.status),k&&k.call(null,h),delete F[h.req]);switch(h.raw){case l.IDENT:b=a.getProperty("userinfo");b.set(f.extend({},h.user,{channel:h.channel.id,state:h.channel.state}));c.debug?d.show("\u5df2\u52a0\u5165\u623f\u95f4\uff08"+b.channel+"\uff09\u3002"):
...
h.user;d.show(h.data,h.user,h.type);n.dispatchEvent(g.CHATEASE_MESSAGE,h);break;case l.JOIN:b=t(h.user.role);d.show((b?b+" ":"")+h.user.name+" \u8fdb\u5165\u623f\u95f4\u3002");n.dispatchEvent(g.CHATEASE_JOIN,h);break;case l.LEFT:b=t(h.user.role);d.show((b?b+" ":"")+h.user.name+" \u5df2\u79bb\u5f00\u3002");n.dispatchEvent(g.CHATEASE_LEFT,h);break;case l.USERS:n.dispatchEvent(g.CHATEASE_USERS,h);break;case l.EXTERN:n.dispatchEvent(g.CHATEASE_EXTERN,h);break;case l.ERROR:m(h.error.code,h);break;default:f.log("Unknown data type: "+
...
(function(c){var f=c.utils,e=c.events,g=c.embed=function(a){function b(a){switch(a.type){case e.ERROR:case e.CHATEASE_SETUP_ERROR:case e.CHATEASE_RENDER_ERROR:d.errorScreen(a.message);d.dispatchEvent(e.ERROR,a);break;default:d.dispatchEvent(a.type,a)}}var d=f.extend(this,new e.eventdispatcher("embed")),k={},l=null,r=!1;d.embed=function(){try{k=new g.config(a.config),l=new g.embedder(a,k)}catch(u){f.log("Failed to init embedder!");d.dispatchEvent(e.CHATEASE_SETUP_ERROR,{message:"Failed to init embedder!",
render:k.render.name});return}l.addGlobalListener(b);l.embed()};d.errorScreen=function(a){r||(r=!0,c.api.displayError(a,k))};(function(){f.foreach(a.config.events,function(b,c){b=a[b];"function"===f.typeOf(b)&&b.call(a,c)})})()}})(chatease);
