chatease=function(){if(chatease.api)return chatease.api.getInstance.apply(this,arguments)};chatease.version="1.0.22";
...
(function(c){var f=c.utils;c.events.eventdispatcher=function(e){function g(a,b,e){if(a)for(var d=0;d<a.length;d++){var c=a[d];if(c){null!==c.count&&0===--c.count&&delete a[d];try{c.listener(b)}catch(m){f.log('Error handling "'+e+'" event listener ['+d+"]: "+m.toString(),c.listener,b)}}}}var a={},b=[];this.addEventListener=function(b,e,c){try{f.exists(a[b])||(a[b]=[]),"string"===f.typeOf(e)&&(e=(new Function("return "+e))()),a[b].push({listener:e,count:c||null})}catch(r){f.log("error",r)}return!1};
this.removeEventListener=function(b,e){if(a[b]){try{if(void 0===e){a[b]=[];return}var d;for(d=0;d<a[b].length;d++)if(a[b][d].listener.toString()===e.toString()){a[b].splice(d,1);break}}catch(r){f.log("error",r)}return!1}};this.addGlobalListener=function(a,e){try{"string"===f.typeOf(a)&&(a=(new Function("return "+a))()),b.push({listener:a,count:e||null})}catch(h){f.log("error",h)}return!1};this.removeGlobalListener=function(a){if(a){try{var d;for(d=b.length-1;0<=d;d--)b[d].listener.toString()===a.toString()&&
b.splice(d,1)}catch(h){f.log("error",h)}return!1}};this.dispatchEvent=function(d,k){k||(k={});f.extend(k,{id:e,version:c.version,type:d});c.debug&&f.log(d,k);g(a[d],k,d);g(b,k,d)}}})(chatease);
(function(c){var f=c.utils,e=c.events;f.timer=function(c,a){function b(){g++;d.dispatchEvent(e.CHATEASE_TIMER);0<d.repeatCount&&g>=d.repeatCount&&(d.stop(),d.dispatchEvent(e.CHATEASE_TIMER_COMPLETE))}var d=f.extend(this,new e.eventdispatcher("utils.timer")),k,g=0,r=!1;d.start=function(){!1===r&&(k=setInterval(b,d.delay),r=!0)};d.stop=function(){r&&(clearInterval(k),k=0,r=!1)};d.reset=function(){d.stop();g=0};d.currentCount=function(){return g};d.running=function(){return r};d.delay=c||50;d.repeatCount=
a||0}})(chatease);
...
(function(c){var f=c.utils,e=c.events;c=c.core;var g=c.protocol.roles;c=c.renders;var a=c.modes;c.def=function(b,d){function c(a,b,e,d,c){var g=f.createElement("div",b);g.setAttribute("value",!!c);g.innerHTML=a;a=function(a,b){return function(e){e="true"==g.getAttribute("value")?!1:!0;g.setAttribute("value",e);e?f.addClass(g,"checked"):f.removeClass(g,"checked");l.dispatchEvent(a,f.extend({value:e},b))}}(e,d);try{g.addEventListener("click",a)}catch(w){g.attachEvent("onclick",a)}return g}function h(a,
b,e,d){b=f.createElement("div",b);b.innerHTML=a;a=function(a,b){return function(e){l.dispatchEvent(a,b)}}(e,d);try{b.addEventListener("click",a)}catch(A){b.attachEvent("onclick",a)}return b}function r(a){var b,e="icon ";if("number"!=f.typeOf(a)&&(a=parseInt(a),NaN==a||0>a))return null;a&g.SYSTEM?(a&g.SYSTEM)!=g.SYSTEM&&(a&g.SU_ADMIN?(b=f.createElement("span",e+"ico-suadmin"),b.innerText="\u8d85\u7ba1"):(b=f.createElement("span",e+"ico-admin"),b.innerText="\u7ba1\u7406\u5458")):a&g.ANCHOR?(a&g.ANCHOR)==
g.ANCHOR?(b=f.createElement("span",e+"ico-anchor"),b.innerText="\u4e3b\u64ad"):a&g.SECRETARY?(b=f.createElement("span",e+"ico-secretary"),b.innerText="\u79d8\u4e66"):(b=f.createElement("span",e+"ico-assistant"),b.innerText="\u52a9\u7406"):a&g.VIP&&(a=(a&g.VIP)>>>1,b=f.createElement("span",e+("ico-vip"+a)),b.innerText="VIP"+a);return b}var l=f.extend(this,new e.eventdispatcher("renders.def")),m,p,v,x,n,u;l.setup=function(){f.isMSIE(8)||f.isMSIE(9)?_object.setup&&(l.config.debug=!0,_object.setup(l.config),
l.dispatchEvent(e.CHATEASE_READY,{id:l.config.id})):l.dispatchEvent(e.CHATEASE_READY,{id:l.config.id})};l.show=function(a,b,d){"object"!=f.typeOf(b)&&(b={id:0,name:"\u7cfb\u7edf",role:g.SYSTEM});"uni"!=d&&(d="multi");var c=f.createElement("div");(b.role&g.SYSTEM)==g.SYSTEM&&(c.className="cha-system");"uni"==d&&(d=f.createElement("span"),d.innerHTML="[\u5bc6\u8bed]",c.appendChild(d));(d=r(b.role))&&c.appendChild(d);d=f.createElement("a");d.innerHTML=b.name+": ";b=function(a){return function(b){l.dispatchEvent(e.CHATEASE_VIEW_NICKCLICK,
{user:a})}}(b);try{d.addEventListener("click",b)}catch(A){d.attachEvent("onclick",b)}c.appendChild(d);d=f.createElement("span","context");d.innerHTML=a;c.appendChild(d);p.childNodes.length>=l.config.maxrecords&&p.removeChild(p.childNodes[0]);p.appendChild(c);p.scrollTop=p.scrollHeight};l.send=function(){l.dispatchEvent(e.CHATEASE_VIEW_SEND,{data:{data:n.value,type:"multi"}});l.clearInput()};l.clearInput=function(){n.value=""};l.clearScreen=function(){f.emptyElement(p)};l.element=function(){return _object};
l.resize=function(a,b){};l.destroy=function(){};l.name=a.DEFAULT;l.config=f.extend({},{},d);if(f.isMSIE(8)||f.isMSIE(9))b.innerHTML='<object id="cha-swf" name="cha-swf" align="middle" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"><param name="movie" value="'+l.config.swf+'"><param name="quality" value="high"><param name="bgcolor" value="#ffffff"><param name="allowscriptaccess" value="sameDomain"><param name="allowfullscreen" value="true"><param name="wmode" value="transparent"><param name="FlashVars" value="id='+
l.config.id+'"></object>',_object=l.WebSocket=b.firstChild;(function(){m=f.createElement("div","cha-title");b.appendChild(m);m.innerHTML="\u804a\u5929\u5ba4";p=f.createElement("div","cha-console");p.id=l.config.id+"-console";b.appendChild(p);v=f.createElement("div","cha-controls");b.appendChild(v);var a=c("\u5c4f\u853d\u6d88\u606f","cha-checkbox shieldtext",e.CHATEASE_VIEW_PROPERTY,{key:"shield"},!1);v.appendChild(a);a=h("\u6e05\u5c4f","cha-button red clearscreen",e.CHATEASE_VIEW_CLEARSCREEN,null);
v.appendChild(a);x=f.createElement("div","cha-dialog");b.appendChild(x);n=f.createElement("textarea");n.id=l.config.id+"-input";x.appendChild(n);u=f.createElement("button","cha-button red");x.appendChild(u);n.setAttribute("placeholder","\u8f93\u5165\u804a\u5929\u5185\u5bb9");l.config.maxlength&&n.setAttribute("maxlength",l.config.maxlength);a=function(){return function(a){a=window.event||a;13==a.keyCode&&(a.ctrlKey?n.value+="\r\n":(l.send(),window.event?a.returnValue=!1:a.preventDefault()))}}();try{n.addEventListener("keypress",
a)}catch(y){n.attachEvent("onkeypress",a)}u.innerHTML="\u53d1\u9001";a=function(){return function(){l.send()}}();try{u.addEventListener("click",a)}catch(y){u.attachEvent("onclick",a)}})()}})(chatease);
(function(c){var f=c.utils,e=c.events,g=c.core;g.entity=function(a){var b=f.extend(this,new e.eventdispatcher("core.entity")),d,c,h;b.setup=function(){setTimeout(function(){h.setup()},0)};b.destroy=function(){h&&h.stop();c&&c.destroy();d&&d.destroy()};b.id=a.id;b.model=d=new g.model(a);b.view=c=new g.view(d);b.controller=h=new g.controller(d,c);h.addGlobalListener(function(a){b.dispatchEvent(a.type,a)});b.onSWFOpen=h.onOpen;b.onSWFMessage=h.onMessage;b.onSWFError=h.onError;b.onSWFClose=h.onClose;
b.send=h.send;b.getState=d.getState;b.resize=c.resize}})(chatease);
(function(c){var f=c.utils,e=c.events;c=c.core;var g=c.states,a=c.protocol,b=a.roles,d=a.channelStates,k=a.punishments,h=function(){var a=this;_interval=-1;_active=0;a.set=function(e){f.extend(a,e);1==e.hasOwnProperty("role")&&(e=e.role,_interval=0>e?-1:e>=b.ASSISTANT?0:e&b.VIP?500:e==b.NORMAL?1E3:2E3)};a.isMuted=function(){return!!(a.state&d.MUTED|a.punishment.code&k.MUTED)};a.isActive=function(){if(0>_interval)return!1;var a=(new Date).getTime();if(_active&&a-_active<_interval)return!1;_active=
a;return!0};f.extend(a,{channel:null,role:-1,state:0,punishment:{code:0,time:0}})};c.model=function(a){var b=f.extend(this,new e.eventdispatcher("core.model")),d=g.CLOSED,c;b.setState=function(a){a!==d&&(d=a,b.dispatchEvent(e.CHATEASE_STATE,{state:a}))};b.getState=function(){return d};b.setProperty=function(a,d){1==c.hasOwnProperty(a)&&(c[a]=d,b.dispatchEvent(e.CHATEASE_PROPERTY,{key:a,value:d}))};b.getProperty=function(a){return c[a]};b.getConfig=function(a){return b.config[a]};b.destroy=function(){};
b.config=f.extend({},{},a);c={userinfo:new h,shield:!1}}})(chatease);
(function(c){var f=c.utils,e=c.events;c=c.core;var g=c.protocol.roles,a=c.renders,b=c.skins;c.view=function(d){function c(a){if(a.ctrlKey||a.metaKey)return!0;switch(a.keyCode){case 13:n&&n.send()}if(/13/.test(a.keyCode))return a.preventDefault?a.preventDefault():a.returnValue=!1,!1}function h(a){m.resize()}function r(a){l(a)}function l(a){m.dispatchEvent(a.type,a)}var m=f.extend(this,new e.eventdispatcher("core.view")),p,v,x,n,u;m.setup=function(){n?(n.setup(),m.resize()):m.dispatchEvent(e.CHATEASE_SETUP_ERROR,
{message:"Render not available!",name:d.config.render.name})};m.show=function(a,b,e){(!b||b.role&g.SYSTEM||!d.getProperty("shield"))&&n&&n.show(a,b,e)};m.resize=function(a,b){setTimeout(function(){n&&n.resize(a,b);u&&u.resize(a,b)},0)};m.destroy=function(){p&&p.removeEventListener("keydown",c);n&&n.destroy()};(function(){p=f.createElement("div","cha-wrapper cha-skin-"+d.getConfig("skin").name);p.id=d.getConfig("id");p.tabIndex=0;v=f.createElement("div","cha-render");x=f.createElement("div","cha-contextmenu");
p.appendChild(v);p.appendChild(x);var g=f.extend({},d.getConfig("render"),{id:d.getConfig("id"),url:d.getConfig("url"),width:d.getConfig("width"),height:d.getConfig("height"),maxlength:d.getConfig("maxlength"),maxrecords:d.getConfig("maxrecords")});try{n=m.render=new a[g.name](v,g),n.addEventListener(e.CHATEASE_READY,l),n.addEventListener(e.CHATEASE_VIEW_SEND,l),n.addEventListener(e.CHATEASE_VIEW_PROPERTY,l),n.addEventListener(e.CHATEASE_VIEW_CLEARSCREEN,l),n.addEventListener(e.CHATEASE_VIEW_NICKCLICK,
l),n.addEventListener(e.CHATEASE_RENDER_ERROR,r)}catch(y){f.log("Failed to init render "+g.name+"!")}g=f.extend({},d.getConfig("skin"),{id:d.getConfig("id"),width:d.config.width,height:d.config.height});try{u=new b[g.name](g)}catch(y){f.log("Failed to init skin "+g.name+"!")}g=document.getElementById(d.getConfig("id"));g.parentNode.replaceChild(p,g);try{p.addEventListener("keydown",c),window.addEventListener("resize",h)}catch(y){p.attachEvent("onkeydown",c),window.attachEvent("onresize",h)}})()}})(chatease);
(function(c){var f=c.utils,e=f.crypt,g=c.events;c=c.core;var a=c.states,b=c.protocol,d=b.cmds,k=b.raws,h=b.roles,r=b.channelStates,l=b.punishments,m=b.errors;c.controller=function(b,c){function p(){if(t&&b.getState()==a.CONNECTED)f.log("Websocket had connected already.");else{c.show("\u804a\u5929\u5ba4\u8fde\u63a5\u4e2d\u2026");try{window.WebSocket=window.WebSocket||window.MozWebSocket,window.WebSocket?(t=new WebSocket(b.config.url,"binary"),t.binaryType="arraybuffer",t.onopen=q.onOpen,t.onmessage=
q.onMessage,t.onerror=q.onError,t.onclose=q.onClose):(t=c.render.WebSocket,t.connect())}catch(G){f.log("Failed to initialize websocket: "+G),u(m.NOT_ACCEPTABLE,null)}}}function n(a){var b="";if("number"!=f.typeOf(a)&&(a=parseInt(a),NaN==a||0>a))return"";a&h.SYSTEM?b=(a&h.SYSTEM)==h.SYSTEM?b+"[\u7cfb\u7edf]":a&h.SU_ADMIN?b+"[\u8d85\u7ba1]":b+"[\u7ba1\u7406\u5458]":a&h.ANCHOR?b=(a&h.ANCHOR)==h.ANCHOR?b+"[\u4e3b\u64ad]":a&h.SECRETARY?b+"[\u52a9\u7406]":b+"[\u623f\u7ba1]":a&h.VIP?b+="[VIP"+((a&h.VIP)-
1)+"]":(a&h.NORMAL)!=h.NORMAL&&(b+="[\u6e38\u5ba2]");return b}function u(a,b){var e=v(a);e&&c.show(e);var d={raw:"error",error:{code:a,explain:e}};f.foreach(b,function(a,b){"cmd"!=a&&"raw"!=a&&"error"!=a&&(d[a]=b)});q.dispatchEvent(g.ERROR,d)}function v(a){var b="";switch(a){case m.BAD_REQUEST:b="\u9519\u8bef\u8bf7\u6c42\uff01";break;case m.UNAUTHORIZED:b="\u8bf7\u5148\u767b\u5f55\uff01";break;case m.FORBIDDEN:b="\u6743\u9650\u9519\u8bef\uff01";break;case m.NOT_FOUND:b="\u672a\u77e5\u8bf7\u6c42\uff01";
...
function y(a){w||(w=new f.timer(a,1),w.addEventListener(g.PLAYEASE_TIMER,function(a){p()}));w.delay=a;w.reset();w.start()}function z(a){q.dispatchEvent(a.type,a)}var q=f.extend(this,new g.eventdispatcher("core.controller")),A=!1,t,w,C,B,F,D=0;q.setup=function(a){A||c.setup()};q.send=function(c,d){if(t&&b.getState()==a.CONNECTED)if("object"!=f.typeOf(c)||0==c.hasOwnProperty("cmd"))u(m.BAD_REQUEST,c);else{var g=b.getProperty("userinfo");if(0==g.isActive())u(m.CONFLICT,c);else if(1==g.isMuted())u(m.FORBIDDEN,
c);else{d&&(g=F++,B[g]=d,c.req=g);c=JSON.stringify(c);try{var k=e.stringToUTF8ByteArray(c),l=new Uint8Array(k);t.send(l.buffer);return}catch(H){}try{t.send(c)}catch(H){}}}else p()};q.onOpen=function(c){b.setState(a.CONNECTED)};q.onMessage=function(a){var d=a.data;"arraybuffer"===f.typeOf(a.data)&&(d=new Uint8Array(a.data),d=e.UTF8ByteArrayToString(d));var h;try{h=eval("("+d+")")}catch(E){f.log("Failed to parse JSON. \nError: "+E+"\ndata: "+a.data);return}h.hasOwnProperty("req")&&B.hasOwnProperty(h.req)&&
(a=B[h.req],d=a.result,h.raw==k.ERROR&&(d=a.status),d&&d.call(null,h),delete B[h.req]);switch(h.raw){case k.IDENT:a=b.getProperty("userinfo");a.set(f.extend({},h.user,{channel:h.channel.id,state:h.channel.state}));c.show("\u5df2\u52a0\u5165\u623f\u95f4\uff08"+a.channel+"\uff09\u3002");a.state&r.MUTED&&c.show("\u60a8\u6240\u5728\u7684\u7528\u6237\u7ec4\u4e0d\u80fd\u53d1\u8a00\uff01");a.punishment.code&l.MUTED&&(d=new Date,d.setTime(a.punishment.time),c.show("\u60a8\u5df2\u88ab\u7981\u8a00\u81f3\uff08"+
f.formatTime(d)+"\uff09\uff01"));q.dispatchEvent(g.CHATEASE_INDENT,h);break;case k.TEXT:try{C||(C=new f.filter(b.keywords)),h.data=C.replace(h.data)}catch(E){f.log("Failed to execute filter.")}c.show(h.data,h.user,h.type);q.dispatchEvent(g.CHATEASE_MESSAGE,h);break;case k.JOIN:a=n(h.user.role);c.show((a?a+" ":"")+h.user.name+" \u8fdb\u5165\u623f\u95f4\u3002");q.dispatchEvent(g.CHATEASE_JOIN,h);break;case k.LEFT:a=n(h.user.role);c.show((a?a+" ":"")+h.user.name+" \u5df2\u79bb\u5f00\u3002");q.dispatchEvent(g.CHATEASE_LEFT,
h);break;case k.USERS:q.dispatchEvent(g.CHATEASE_USERS,h);break;case k.ERROR:u(h.error.code,h);break;default:f.log("Unknown data type: "+h.raw+", ignored.")}};q.onError=function(c){b.setState(a.ERROR)};q.onClose=function(c){b.setState(a.CLOSED)};q.close=function(){t&&t.close()};B={};F=0;b.addEventListener(g.CHATEASE_STATE,function(d){switch(d.state){case a.CONNECTED:c.show("\u804a\u5929\u5ba4\u5df2\u8fde\u63a5\u2026");D=0;q.dispatchEvent(g.CHATEASE_CONNECT);break;case a.CLOSED:c.show("\u804a\u5929\u5ba4\u8fde\u63a5\u5df2\u65ad\u5f00\uff01");
q.dispatchEvent(g.CHATEASE_CLOSE,{channel:{id:b.channel}});if(0>b.config.maxretries||D<b.config.maxretries)d=Math.ceil(b.config.retrydelay+5E3*Math.random()),c.show("\u6b63\u5728\u51c6\u5907\u91cd\u8fde\uff0c"+d/1E3+"\u79d2..."),D++,y(d);break;case a.ERROR:c.show("\u804a\u5929\u5ba4\u5f02\u5e38\uff01");q.dispatchEvent(g.ERROR,{message:"Chat room error!",channel:{id:b.channel}});break;default:q.dispatchEvent(g.ERROR,{message:"Unknown model state!",state:d.state})}});b.addEventListener(g.CHATEASE_PROPERTY,
function(a){z(a)});c.addEventListener(g.CHATEASE_READY,function(a){A||(f.log("Chat ready!"),A=!0,z(a),p(),window.onbeforeunload=function(a){t&&b.getState()})});c.addEventListener(g.CHATEASE_SETUP_ERROR,function(c){b.setState(a.ERROR);z(c)});c.addEventListener(g.CHATEASE_VIEW_SEND,function(a){var e=a.data.data;if(e){0<=b.config.maxlength&&(e=e.substr(0,b.config.maxlength));var e=f.trim(e),g=b.getProperty("userinfo");q.send({cmd:d.TEXT,data:e,type:a.data.type,channel:{id:g.channel}})}else c.show("\u8bf7\u8f93\u5165\u5185\u5bb9\uff01")});
c.addEventListener(g.CHATEASE_VIEW_PROPERTY,function(a){b.setProperty(a.key,a.value)});c.addEventListener(g.CHATEASE_VIEW_CLEARSCREEN,function(a){c.render.clearScreen();z(a)});c.addEventListener(g.CHATEASE_VIEW_NICKCLICK,function(a){var c=b.getProperty("userinfo");a.channel={id:c.channel,state:c.state};z(a)});c.addEventListener(g.CHATEASE_RENDER_ERROR,function(c){b.setState(a.ERROR);z(c)})}})(chatease);
(function(c){var f=c.utils,e=c.events,g=c.embed=function(a){function b(a){switch(a.type){case e.ERROR:case e.CHATEASE_SETUP_ERROR:case e.CHATEASE_RENDER_ERROR:d.errorScreen(a.message);d.dispatchEvent(e.ERROR,a);break;default:d.dispatchEvent(a.type,a)}}var d=f.extend(this,new e.eventdispatcher("embed")),k={},h=null,r=!1;d.embed=function(){try{k=new g.config(a.config),h=new g.embedder(a,k)}catch(l){f.log("Failed to init embedder!");d.dispatchEvent(e.CHATEASE_SETUP_ERROR,{message:"Failed to init embedder!",
render:k.render.name});return}h.addGlobalListener(b);h.embed()};d.errorScreen=function(a){r||(r=!0,c.api.displayError(a,k))};(function(){f.foreach(a.config.events,function(b,c){b=a[b];"function"===f.typeOf(b)&&b.call(a,c)})})()}})(chatease);
