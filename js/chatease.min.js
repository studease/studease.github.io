chatease=function(){if(chatease.api)return chatease.api.getInstance.apply(this,arguments)};chatease.version="1.0.32";
...
c&63|128)}return f};d.UTF8ByteArrayToString=function(e){for(var f=[],a=0,b=0;a<e.length;){var c=e[a++];if(128>c)f[b++]=String.fromCharCode(c);else if(191<c&&224>c){var k=e[a++];f[b++]=String.fromCharCode((c&31)<<6|k&63)}else if(239<c&&365>c){var k=e[a++],d=e[a++],l=e[a++],c=((c&7)<<18|(k&63)<<12|(d&63)<<6|l&63)-65536;f[b++]=String.fromCharCode(55296+(c>>10));f[b++]=String.fromCharCode(56320+(c&1023))}else k=e[a++],d=e[a++],f[b++]=String.fromCharCode((c&15)<<12|(k&63)<<6|d&63)}return f.join("")};d.XORByteArray=
...
(function(d){var f=d.utils;d.events.eventdispatcher=function(e){function g(a,b,e){if(a)for(var c=0;c<a.length;c++){var d=a[c];if(d){null!==d.count&&0===--d.count&&delete a[c];try{d.listener(b)}catch(h){f.log('Error handling "'+e+'" event listener ['+c+"]: "+h.toString(),d.listener,b)}}}}var a={},b=[];this.addEventListener=function(b,e,d){try{f.exists(a[b])||(a[b]=[]),"string"===f.typeOf(e)&&(e=(new Function("return "+e))()),a[b].push({listener:e,count:d||null})}catch(l){f.log("error",l)}return!1};
...
b.splice(c,1)}catch(n){f.log("error",n)}return!1}};this.dispatchEvent=function(c,k){k||(k={});f.extend(k,{id:e,version:d.version,type:c});"events"===d.debug&&f.log(c,k);g(a[c],k,c);g(b,k,c)}}})(chatease);
(function(d){var f=d.utils,e=d.events;f.timer=function(d,a){function b(){g++;c.dispatchEvent(e.CHATEASE_TIMER);0<c.repeatCount&&g>=c.repeatCount&&(c.stop(),c.dispatchEvent(e.CHATEASE_TIMER_COMPLETE))}var c=f.extend(this,new e.eventdispatcher("utils.timer")),k,g=0,l=!1;c.start=function(){!1===l&&(k=setInterval(b,c.delay),l=!0)};c.stop=function(){l&&(clearInterval(k),k=0,l=!1)};c.reset=function(){c.stop();g=0};c.currentCount=function(){return g};c.running=function(){return l};c.delay=d||50;c.repeatCount=
a||0}})(chatease);
...
!!a.debug;k.config=a;k.config.id=k.id;k.embedder=new d.embed(k);k.embedder.addGlobalListener(c);k.embedder.embed();return k};k.setEntity=function(a,b){g=a;k.onSWFLoaded=g.setup;k.onSWFOpen=g.onSWFOpen;k.onSWFMessage=g.onSWFMessage;k.onSWFError=g.onSWFError;k.onSWFClose=g.onSWFClose;k.send=g.send;k.close=g.close;k.getState=g.getState;k.resize=g.resize};(function(){f.foreach(a,function(a,b){k[a]=function(a){k.addEventListener(b,a)}})})()};d.api.getInstance=function(a){var b;null==a?a=0:a.nodeType?b=
...
"background-color":"#F8F8F8","overflow-x":"hidden","overflow-y":"scroll"});a("."+b+" .cha-render .cha-console > div",{margin:"6px","line-height":"20px"});a("."+b+" .cha-render .cha-console > div.cha-system, ."+b+" .cha-render .cha-console > div.cha-system > a",{"font-style":"normal","font-weight":"normal",color:"#33CC00",cursor:"default","pointer-events":"none"});a("."+b+" .cha-render .cha-console > div .icon",{"float":"left","margin-right":"4px",width:"20px",height:"20px",display:"block"});a("."+
b+" .cha-render .cha-console > div .icon img",{width:"100%",height:"100%",display:"inline-block"});a("."+b+" .cha-render .cha-console > div .title",{"margin-right":"2px",padding:"0 2px",font:"normal 12px Microsoft YaHei,arial,sans-serif","white-space":"nowrap","word-spacing":"normal",border:"1px solid #3CAFAB","border-radius":"2px","vertical-align":"middle"});a("."+b+" .cha-render .cha-console > div .title.ttl-visitor, ."+b+" .cha-render .cha-console > div .title.ttl-normal, ."+b+" .cha-render .cha-console > div .title.ttl-system",
...
{"word-break":"break-all","word-wrap":"break-word"});a("."+b+" .cha-render .cha-controls",{height:"40px",right:"0",bottom:"60px",left:"0",position:"absolute",overflow:"hidden","line-height":"100%","background-color":"inherit"});a("."+b+" .cha-render .cha-controls > *",{margin:"8px 0","text-align":"center","line-height":"24px",display:"block"});a("."+b+" .cha-render .cha-controls .shieldtext",{"float":"left"});a("."+b+" .cha-render .cha-controls .shieldtext .icon",{padding:"5px"});a("."+b+" .cha-render .cha-controls .clearscreen",
{"float":"right",width:"50px"});a("."+b+" .cha-render .cha-dialog",{height:"60px",right:"0",bottom:"0",left:"0",position:"absolute",overflow:"hidden","background-color":"#E0E0E0"});a("."+b+" .cha-render .cha-dialog .more",{display:"none"});a("."+b+" .cha-render .cha-dialog textarea",{padding:"6px 10px",width:d.config.width-124+"px",height:"48px",resize:"none",border:"0 none","background-color":"#E6E6E6"});a("."+b+" .cha-render .cha-dialog .send",{"float":"right",width:"50px",height:"100%"})}})(chatease);
...
"background-color":"#F8F8F8","overflow-x":"hidden","overflow-y":"scroll"});a("."+b+" .cha-render.more .cha-console",{bottom:"120px"});a("."+b+" .cha-render .cha-console > div",{margin:"6px","line-height":"20px"});a("."+b+" .cha-render .cha-console > div.cha-system, ."+b+" .cha-render .cha-console > div.cha-system > a",{"font-style":"normal","font-weight":"normal",color:"#33CC00",cursor:"default","pointer-events":"none"});a("."+b+" .cha-render .cha-console > div .icon",{"float":"left","margin-right":"4px",
width:"20px",height:"20px",display:"block"});a("."+b+" .cha-render .cha-console > div .icon img",{width:"100%",height:"100%",display:"inline-block"});a("."+b+" .cha-render .cha-console > div .title",{"margin-right":"2px",padding:"0 2px",font:"normal 12px Microsoft YaHei,arial,sans-serif","white-space":"nowrap","word-spacing":"normal",border:"1px solid #3CAFAB","border-radius":"2px","vertical-align":"middle"});a("."+b+" .cha-render .cha-console > div .title.ttl-visitor, ."+b+" .cha-render .cha-console > div .title.ttl-normal, ."+
...
var h=f.extend(this,new e.eventdispatcher("renders.def")),x,q,r,u,y,v,p;h.setup=function(){f.isMSIE("(8|9)")?_object.setup&&(_object.setup(h.config),h.dispatchEvent(e.CHATEASE_READY,{id:h.config.id})):h.dispatchEvent(e.CHATEASE_READY,{id:h.config.id})};h.show=function(a,b,c){"object"!=f.typeOf(b)&&(b={id:0,name:"\u7cfb\u7edf",role:g.SYSTEM});"uni"!=c&&(c="multi");var d=f.createElement("div");(b.role&g.SYSTEM)==g.SYSTEM&&(d.className="cha-system");var k=l(b.icon);k&&d.appendChild(k);"uni"==c&&(c=f.createElement("span"),
c.innerHTML="[\u5bc6\u8bed]",d.appendChild(c));(c=A(b.role))&&d.appendChild(c);c=f.createElement("a");c.innerHTML=b.name+": ";b=function(a){return function(b){h.dispatchEvent(e.CHATEASE_VIEW_NICKCLICK,{user:a})}}(b);try{c.addEventListener("click",b)}catch(I){c.attachEvent("onclick",b)}d.appendChild(c);c=f.createElement("span","context");c.innerHTML=a;d.appendChild(c);q.childNodes.length>=h.config.maxrecords&&q.removeChild(q.childNodes[0]);q.appendChild(d);q.scrollTop=q.scrollHeight};h.send=function(){h.dispatchEvent(e.CHATEASE_VIEW_SEND,
{data:{data:v.value,type:"multi"}});h.clearInput()};h.clearInput=function(){v.value=""};h.clearScreen=function(){f.emptyElement(q)};h.element=function(){return _object};h.resize=function(a,b){};h.destroy=function(){};h.name=a.DEFAULT;h.config=f.extend({},{},c);f.isMSIE("(8|9)")&&(b.innerHTML='<object id="cha-swf" name="cha-swf" align="middle" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"><param name="movie" value="'+h.config.swf+'"><param name="quality" value="high"><param name="bgcolor" value="#ffffff"><param name="allowscriptaccess" value="sameDomain"><param name="allowfullscreen" value="true"><param name="wmode" value="transparent"><param name="FlashVars" value="id='+
h.config.id+'"></object>',_object=h.WebSocket=b.firstChild);(function(){h.config.title&&(x=f.createElement("div","cha-title"),b.appendChild(x),x.innerHTML=h.config.title);q=f.createElement("div","cha-console");q.id=h.config.id+"-console";b.appendChild(q);r=f.createElement("div","cha-controls");b.appendChild(r);var a=d("\u5c4f\u853d\u6d88\u606f","cha-checkbox shieldtext",e.CHATEASE_VIEW_PROPERTY,{key:"shield"},!1);r.appendChild(a);a=n("\u6e05\u5c4f","cha-button white clearscreen",e.CHATEASE_VIEW_CLEARSCREEN,
null);r.appendChild(a);u=f.createElement("div","cha-dialog");b.appendChild(u);y=d("","more",e.CHATEASE_VIEW_PROPERTY,{key:"more"},!1);u.appendChild(y);v=f.createElement("textarea");v.id=h.config.id+"-input";u.appendChild(v);p=f.createElement("button","cha-button blue send");u.appendChild(p);v.setAttribute("placeholder","\u8f93\u5165\u804a\u5929\u5185\u5bb9");h.config.maxlength&&v.setAttribute("maxlength",h.config.maxlength);a=function(){return function(a){a=window.event||a;13==a.keyCode&&(a.ctrlKey?
v.value+="\r\n":(h.send(),window.event?a.returnValue=!1:a.preventDefault()))}}();try{v.addEventListener("keypress",a)}catch(m){v.attachEvent("onkeypress",a)}p.innerHTML="\u53d1\u9001";a=function(){return function(){h.send()}}();try{p.addEventListener("click",a)}catch(m){p.attachEvent("onclick",a)}})()}})(chatease);
...
(function(d){var f=d.utils,e=d.events;d=d.core;var g=d.protocol.roles,a=d.renders,b=a.modes,c=d.skins;d.view=function(d){function k(a){if(a.ctrlKey||a.metaKey)return!0;switch(a.keyCode){case 13:p&&p.send()}if(/13/.test(a.keyCode))return a.preventDefault?a.preventDefault():a.returnValue=!1,!1}function l(a){r.resize()}function A(a){switch(a.key){case "more":a.value?f.addClass(y,"more"):f.removeClass(y,"more")}q(a)}function h(a){r.dispatchEvent(e.CHATEASE_NICKCLICK,{user:a.user})}function x(a){q(a)}
function q(a){r.dispatchEvent(a.type,a)}var r=f.extend(this,new e.eventdispatcher("core.view")),u,y,v,p,w;r.setup=function(){p?(p.setup(),r.resize()):r.dispatchEvent(e.CHATEASE_SETUP_ERROR,{message:"Render not available!",name:d.config.render.name})};r.show=function(a,b,c){(!b||b.role&g.SYSTEM||!d.getProperty("shield"))&&p&&p.show(a,b,c)};r.resize=function(a,b){setTimeout(function(){p&&p.resize(a,b);w&&w.resize(a,b)},0)};r.destroy=function(){u&&u.removeEventListener("keydown",k);p&&p.destroy()};(function(){u=
f.createElement("div","cha-wrapper cha-skin-"+d.getConfig("skin").name);u.id=d.getConfig("id");y=f.createElement("div","cha-render");v=f.createElement("div","cha-contextmenu");u.appendChild(y);u.appendChild(v);var g=f.extend({},d.getConfig("render"),{id:d.getConfig("id"),url:d.getConfig("url"),width:d.getConfig("width"),height:d.getConfig("height"),maxlength:d.getConfig("maxlength"),maxrecords:d.getConfig("maxrecords")});try{p=r.render=new a[g.name](y,g),p.addEventListener(e.CHATEASE_READY,q),p.addEventListener(e.CHATEASE_VIEW_SEND,
q),p.addEventListener(e.CHATEASE_VIEW_PROPERTY,A),p.addEventListener(e.CHATEASE_VIEW_CLEARSCREEN,q),p.addEventListener(e.CHATEASE_VIEW_NICKCLICK,h),p.addEventListener(e.CHATEASE_RENDER_ERROR,x)}catch(B){f.log("Failed to init render "+g.name+"!")}g=f.extend({},d.getConfig("skin"),{id:d.getConfig("id"),width:d.config.width,height:d.config.height,title:!!d.getConfig("render").title});try{w=new c[g.name](g)}catch(B){f.log("Failed to init skin "+g.name+"!")}if(!p||p.name!=b.NONE){g=document.getElementById(d.getConfig("id"));
g.parentNode.replaceChild(u,g);try{u.addEventListener("keydown",k),window.addEventListener("resize",l)}catch(B){u.attachEvent("onkeydown",k),window.attachEvent("onresize",l)}}})()}})(chatease);
(function(d){var f=d.utils,e=f.crypt,g=d.events,a=d.core,b=a.states,c=a.protocol,k=c.cmds,n=c.raws,l=c.roles,A=c.punishments,h=c.errors;a.controller=function(a,c){function r(){if(t){if(a.getState()==b.CONNECTED){f.log("Websocket had connected already.");return}t.readyState!=WebSocket.CONNECTING&&t.readyState!=WebSocket.OPEN||t.close()}d.debug?c.show("\u804a\u5929\u5ba4\u8fde\u63a5\u4e2d\u2026"):f.log("\u804a\u5929\u5ba4\u8fde\u63a5\u4e2d\u2026");try{window.WebSocket=window.WebSocket||window.MozWebSocket,
window.WebSocket?(t=new WebSocket(a.config.url,"binary"),t.binaryType="arraybuffer",t.onopen=m.onOpen,t.onmessage=m.onMessage,t.onerror=m.onError,t.onclose=m.onClose):(t=c.render.WebSocket,t.connect())}catch(E){f.log("Failed to initialize websocket: "+E),q(h.NOT_ACCEPTABLE,null)}}function u(a){var b="";if("number"!=f.typeOf(a)&&(a=parseInt(a),NaN==a||0>a))return"";a&l.SYSTEM?b=(a&l.SYSTEM)==l.SYSTEM?b+"[\u7cfb\u7edf]":a&l.SU_ADMIN?b+"[\u8d85\u7ba1]":b+"[\u7ba1\u7406\u5458]":a&l.ANCHOR?b=(a&l.ANCHOR)==
l.ANCHOR?b+"[\u4e3b\u64ad]":a&l.SECRETARY?b+"[\u52a9\u7406]":b+"[\u623f\u7ba1]":a&l.VIP?b+="[VIP"+((a&l.VIP)-1)+"]":(a&l.NORMAL)!=l.NORMAL&&(b+="[\u6e38\u5ba2]");return b}function q(a,b){var d=v(a);d&&c.show(d);var e={raw:"error",error:{code:a,explain:d}};f.foreach(b,function(a,b){"cmd"!=a&&"raw"!=a&&"error"!=a&&(e[a]=b)});m.dispatchEvent(g.ERROR,e)}function v(a){var b="";switch(a){case h.BAD_REQUEST:b="\u9519\u8bef\u8bf7\u6c42\uff01";break;case h.UNAUTHORIZED:b="\u8bf7\u5148\u767b\u5f55\uff01";break;
case h.FORBIDDEN:b="\u6743\u9650\u9519\u8bef\uff01";break;case h.NOT_FOUND:b="\u672a\u77e5\u8bf7\u6c42\uff01";break;case h.NOT_ACCEPTABLE:b="\u65e0\u6cd5\u8bc6\u522b\uff01";break;case h.REQUEST_TIMEOUT:b="\u8bf7\u6c42\u8d85\u65f6\uff01";break;case h.CONFLICT:b="\u64cd\u4f5c\u9891\u7e41\uff01";break;case h.EXPECTATION_FAILED:b="\u64cd\u4f5c\u5931\u8d25\uff01";break;case h.INTERNAL_SERVER_ERROR:b="\u5185\u90e8\u9519\u8bef\uff01";break;case h.NOT_IMPLEMENTED:b="\u65e0\u6cd5\u8bc6\u522b\uff01";break;
case h.BAD_GATEWAY:b="\u54cd\u5e94\u65e0\u6548\uff01";break;case h.SERVICE_UNAVAILABLE:b="\u670d\u52a1\u8fc7\u8f7d\uff01";break;case h.GATEWAY_TIMEOUT:b="\u7f51\u5173\u8d85\u65f6\uff01"}return b}function p(a){z||(z=new f.timer(a,1),z.addEventListener(g.CHATEASE_TIMER,function(a){r()}));z.delay=a;z.reset();z.start()}function w(a){m.dispatchEvent(a.type,a)}var m=f.extend(this,new g.eventdispatcher("core.controller")),B=!1,t,z,x,C,F,D=0;m.setup=function(a){B||c.setup()};m.send=function(c,d){if(t&&a.getState()==
b.CONNECTED)if("object"!=f.typeOf(c)||0==c.hasOwnProperty("cmd"))q(h.BAD_REQUEST,c);else{var g=a.getProperty("userinfo");if(0==g.isActive())q(h.CONFLICT,c);else if(1==g.isMuted())q(h.EXPECTATION_FAILED,c);else{d&&(g=F++,C[g]=d,c.req=g);c=JSON.stringify(c);try{var k=e.stringToUTF8ByteArray(c),E=new Uint8Array(k);t.send(E.buffer);return}catch(H){}try{t.send(c)}catch(H){}}}else r()};m.onOpen=function(c){a.setState(b.CONNECTED)};m.onMessage=function(b){var k=b.data;"arraybuffer"===f.typeOf(b.data)&&(k=
new Uint8Array(b.data),k=e.UTF8ByteArrayToString(k));var h;try{h=eval("("+k+")")}catch(G){f.log("Failed to parse JSON. \nError: "+G+"\ndata: "+b.data);return}h.hasOwnProperty("req")&&C.hasOwnProperty(h.req)&&(b=C[h.req],k=b.result,h.raw==n.ERROR&&(k=b.status),k&&k.call(null,h),delete C[h.req]);switch(h.raw){case n.IDENT:b=a.getProperty("userinfo");b.set(f.extend({},h.user,{channel:h.channel.id,state:h.channel.state}));d.debug?c.show("\u5df2\u52a0\u5165\u623f\u95f4\uff08"+b.channel+"\uff09\u3002"):
f.log("\u5df2\u52a0\u5165\u623f\u95f4\uff08"+b.channel+"\uff09\u3002");b.role<b.state&&c.show("\u60a8\u6240\u5728\u7684\u7528\u6237\u7ec4\u4e0d\u80fd\u53d1\u8a00\uff01");b.punishment.code&A.MUTED&&(k=new Date,k.setTime(b.punishment.time),c.show("\u60a8\u5df2\u88ab\u7981\u8a00\u81f3\uff08"+f.formatTime(k)+"\uff09\uff01"));m.dispatchEvent(g.CHATEASE_INDENT,h);break;case n.TEXT:try{x||(x=new f.filter(a.config.keywords)),h.data=x.replace(h.data)}catch(G){f.log("Failed to execute filter.")}c.show(h.data,
h.user,h.type);m.dispatchEvent(g.CHATEASE_MESSAGE,h);break;case n.JOIN:b=u(h.user.role);c.show((b?b+" ":"")+h.user.name+" \u8fdb\u5165\u623f\u95f4\u3002");m.dispatchEvent(g.CHATEASE_JOIN,h);break;case n.LEFT:b=u(h.user.role);c.show((b?b+" ":"")+h.user.name+" \u5df2\u79bb\u5f00\u3002");m.dispatchEvent(g.CHATEASE_LEFT,h);break;case n.USERS:m.dispatchEvent(g.CHATEASE_USERS,h);break;case n.EXTERN:m.dispatchEvent(g.CHATEASE_EXTERN,h);break;case n.ERROR:q(h.error.code,h);break;default:f.log("Unknown data type: "+
h.raw+", ignored.")}};m.onError=function(c){a.setState(b.ERROR)};m.onClose=function(c){a.setState(b.CLOSED)};m.close=function(){t&&t.close()};C={};F=0;a.addEventListener(g.CHATEASE_STATE,function(e){switch(e.state){case b.CONNECTED:d.debug?c.show("\u804a\u5929\u5ba4\u5df2\u8fde\u63a5\u2026"):f.log("\u804a\u5929\u5ba4\u5df2\u8fde\u63a5\u2026");D=0;m.dispatchEvent(g.CHATEASE_CONNECT);break;case b.CLOSED:d.debug?c.show("\u804a\u5929\u5ba4\u8fde\u63a5\u5df2\u65ad\u5f00\uff01"):f.log("\u804a\u5929\u5ba4\u8fde\u63a5\u5df2\u65ad\u5f00\uff01");
...
break;default:m.dispatchEvent(g.ERROR,{message:"Unknown model state!",state:e.state})}});a.addEventListener(g.CHATEASE_PROPERTY,function(a){w(a)});c.addEventListener(g.CHATEASE_READY,function(b){B||(f.log("Chat ready!"),B=!0,w(b),d.debug||c.show("\u804a\u5929\u5ba4\u5df2\u8fde\u63a5\uff01"),r(),window.onbeforeunload=function(b){t&&a.getState()})});c.addEventListener(g.CHATEASE_SETUP_ERROR,function(c){a.setState(b.ERROR);w(c)});c.addEventListener(g.CHATEASE_VIEW_SEND,function(b){var d=b.data.data;
if(d){0<=a.config.maxlength&&(d=d.substr(0,a.config.maxlength));var d=f.trim(d),e=a.getProperty("userinfo");m.send({cmd:k.TEXT,data:d,type:b.data.type,channel:{id:e.channel}})}else c.show("\u8bf7\u8f93\u5165\u5185\u5bb9\uff01")});c.addEventListener(g.CHATEASE_VIEW_PROPERTY,function(b){a.setProperty(b.key,b.value)});c.addEventListener(g.CHATEASE_VIEW_CLEARSCREEN,function(a){c.render.clearScreen();w(a)});c.addEventListener(g.CHATEASE_VIEW_NICKCLICK,function(b){var c=a.getProperty("userinfo");b.channel=
{id:c.channel,state:c.state};w(b)});c.addEventListener(g.CHATEASE_RENDER_ERROR,function(c){a.setState(b.ERROR);w(c)})}})(chatease);
(function(d){var f=d.utils,e=d.events,g=d.embed=function(a){function b(a){switch(a.type){case e.ERROR:case e.CHATEASE_SETUP_ERROR:case e.CHATEASE_RENDER_ERROR:c.errorScreen(a.message);c.dispatchEvent(e.ERROR,a);break;default:c.dispatchEvent(a.type,a)}}var c=f.extend(this,new e.eventdispatcher("embed")),k={},n=null,l=!1;c.embed=function(){try{k=new g.config(a.config),n=new g.embedder(a,k)}catch(A){f.log("Failed to init embedder!");c.dispatchEvent(e.CHATEASE_SETUP_ERROR,{message:"Failed to init embedder!",
render:k.render.name});return}n.addGlobalListener(b);n.embed()};c.errorScreen=function(a){l||(l=!0,d.api.displayError(a,k))};(function(){f.foreach(a.config.events,function(b,c){b=a[b];"function"===f.typeOf(b)&&b.call(a,c)})})()}})(chatease);
